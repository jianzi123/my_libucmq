...
LDLIBSOPTIONS=-lpthread /usr/lib64/librt.so

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ucmq

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ucmq: /usr/lib64/librt.so
...
${OBJECTDIR}/_ext/1445274692/crc16.o: ../../src/crc16.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/crc16.o ../../src/crc16.c

${OBJECTDIR}/_ext/1445274692/file.o: ../../src/file.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/file.o ../../src/file.c

${OBJECTDIR}/_ext/1445274692/log.o: ../../src/log.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/log.o ../../src/log.c

${OBJECTDIR}/_ext/1445274692/main.o: ../../src/main.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/main.o ../../src/main.c

${OBJECTDIR}/_ext/1445274692/mq_api.o: ../../src/mq_api.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/mq_api.o ../../src/mq_api.c

${OBJECTDIR}/_ext/1445274692/mq_config.o: ../../src/mq_config.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/mq_config.o ../../src/mq_config.c

${OBJECTDIR}/_ext/1445274692/mq_errno.o: ../../src/mq_errno.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/mq_errno.o ../../src/mq_errno.c

${OBJECTDIR}/_ext/1445274692/mq_queue_manage.o: ../../src/mq_queue_manage.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/mq_queue_manage.o ../../src/mq_queue_manage.c

${OBJECTDIR}/_ext/1445274692/mq_store_file.o: ../../src/mq_store_file.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/mq_store_file.o ../../src/mq_store_file.c

${OBJECTDIR}/_ext/1445274692/mq_store_manage.o: ../../src/mq_store_manage.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/mq_store_manage.o ../../src/mq_store_manage.c

${OBJECTDIR}/_ext/1445274692/mq_store_msg.o: ../../src/mq_store_msg.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/mq_store_msg.o ../../src/mq_store_msg.c

${OBJECTDIR}/_ext/1445274692/mq_store_rtag.o: ../../src/mq_store_rtag.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/mq_store_rtag.o ../../src/mq_store_rtag.c

${OBJECTDIR}/_ext/1445274692/mq_store_wtag.o: ../../src/mq_store_wtag.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/mq_store_wtag.o ../../src/mq_store_wtag.c

${OBJECTDIR}/_ext/1445274692/mq_util.o: ../../src/mq_util.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/mq_util.o ../../src/mq_util.c

${OBJECTDIR}/_ext/1445274692/util.o: ../../src/util.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} "$@.d"
	$(COMPILE.c) -g -I../../src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1445274692/util.o ../../src/util.c
