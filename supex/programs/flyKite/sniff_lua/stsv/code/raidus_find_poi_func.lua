...
--2014-10-29 增加socket来计算该api的运行时间 
...
module('raidus_find_poi_func', package.seeall)
...
function handle(tb)
	...
	only.log('D',string.format("time use of raidus-find-poi:%d",socket.gettime()-starttime))
	return tbl
