...
{
	return smart_for_alone_vm( W, _vms_cntl );
}
...
{
	int error = 0;
	error = smart_for_alone_vm( W, _vms_init );
	if (error) {
		exit(EXIT_FAILURE);
	}
	return error;
...
{
	int error = smart_for_alone_vm( W, _vms_exit );
...
{
	return smart_for_alone_vm( W, _vms_rfsh );
}
...
{
	return smart_for_alone_vm( W, _vms_sync );
}
...
{
	return smart_for_alone_vm( W, _vms_gain );
}
...
{
	return smart_for_alone_vm( W, _vms_call );
}
...
{
	return smart_for_alone_vm( W, _vms_exec );
}
